  ...
  return (
    <div className="related-products-section">
      ...
      <div className="related-products-swiper">
        ...
        <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" className="product-slider-arrow-right" color="#000" height="20" width="20" xmlns="http://www.w3.org/2000/svg" style={{color:"black"}}><path fill="none" d="M0 0h24v24H0V0z"></path><path d="M6.23 20.23 8 22l10-10L8 2 6.23 3.77 14.46 12z"></path></svg>
        </div>
